...
const HORIZON_0: Capability[] = [
  {
    ...
    smallestExperiment: "Already run: 596 tests against a real Postgres, three audience projections diffed live on /views.",
  ...
  },
  {
    ...
    smallestExperiment: "Already run: 596 tests, 54 browser specs, live SLOs computed from rows on /reliability.",

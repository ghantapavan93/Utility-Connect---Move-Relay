...
export const metadata: Metadata = {
  ...
  description:
    "One move arrives on three channels, no two agree, and the provider's reply is lost. The system holds UNKNOWN, refuses the blind retry, and reconciles. Real Postgres, 527 tests, no mocks.",

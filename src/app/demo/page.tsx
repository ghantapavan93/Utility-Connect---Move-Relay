      ...
      <CineHero
        ...
        credibility={[
          ...
          },
          {
            eyebrow: "Code",
            accent: "recovered",
            body: "Next.js and React over PostgreSQL. Persisted idempotency, append-only audit, durable workflow steps, relationship-based authorization. 205 tests against a real database.",
          },
        ]}
        actions={
          <>
